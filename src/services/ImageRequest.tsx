...
export const GET_ImageByScore = async (data: any) => {
  return axios.post('http://localhost:8088/image/score', data);
};
export const GET_ImageByTrail = async (data: any) => {
  return axios.post('http://localhost:8088/image/trail', data);
};
export const GET_ImageByLike = async (data: any) => {
  return axios.post('http://localhost:8088/image/like', data);
};
export const GET_ImageByCreateTime = async (data: any) => {
  return axios.post('http://localhost:8088/image/createtime', data);
};
