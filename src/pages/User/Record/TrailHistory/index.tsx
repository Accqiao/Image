...
import {ClockCircleOutlined, EyeOutlined, FireOutlined, HeartOutlined} from "@ant-design/icons";
import {useEffect, useState} from "react";
import {GET_TrailHistory} from "@/services/HistoryRequest";
import {useModel} from "@@/plugin-model/useModel";
import InfoDrawer from "../InfoDrawer/index";
import ImageLittleCard from './ImageLittleCard'
      ...
      <Row>
        <Col span={6}
          ...
          >
            {recordData && (
              recordData.map((re)=>{
                const tempTime = re.record.updatetime.substring(0,10)+" "
                ...
                return(
                  ...
                  >
                    ...
                    >
                      <Avatar
                        shape="square"
                        size={64} src={"http://localhost:8088/image/"+re.image.href} />
        ...
        <Col span={7}>
          <Descriptions
            ...
            <Descriptions.Item label="标签们" span={3}>
              {previewImage && previewImage.tags.map((tag)=>{
             ...
             }}>
          {
            previewImage ? (
              <Image
                // @ts-ignore
                // width={'100%'}
                width={previewImage.image.width >= previewImage.image.height ? '100%' : null }
                // height={'100%'}
                style={{
                  maxHeight: 460,
                  // maxWidth:460,
