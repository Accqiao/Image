            ...
            >
              ...
              >
                ...
                <Descriptions.Item label="角色类型">
                  <UserInput thekey={"role"} value={initialState.data.role+"|role"} />
                </Descriptions.Item>
                <Descriptions.Item label="性别">
                  <UserInput thekey={"gender"} value={initialState.data.gender} />
                </Descriptions.Item>
                <Descriptions.Item label="邮箱" >
                  <UserInput thekey={"email"} value={initialState.data.email} />
                </Descriptions.Item>
                <Descriptions.Item label="简介" >
                  <UserInput thekey={"introduction"} value={initialState.data.introduction} />
                </Descriptions.Item>
              </Descriptions>
            </Form>
          </Col>
