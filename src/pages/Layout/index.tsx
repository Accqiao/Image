...
import {
  CrownOutlined, DownloadOutlined, EyeOutlined, FlagOutlined, HeartOutlined,
  HomeOutlined, MessageOutlined,
  PictureOutlined, PoweroffOutlined, ReloadOutlined,
  SearchOutlined, SettingOutlined, SmileOutlined, SoundOutlined, StarOutlined,
  TagOutlined, UsergroupAddOutlined, UserOutlined
        ...
        <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
          ...
          <SubMenu key="look" icon={<SmileOutlined />} title="关注">
            <Menu.Item key="users" icon={<UsergroupAddOutlined />}>
              <Link  to="/look/users">订阅</Link>
            </Menu.Item>
            <Menu.Item key="collect" icon={<StarOutlined />}>
              <Link  to="/look/collect">收藏</Link>
            </Menu.Item>
          </SubMenu>
